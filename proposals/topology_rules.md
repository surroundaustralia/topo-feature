...
| 2  |                              | Point fabric consistency         | All geometry vertices must reference cadastral survey marks | ✅ TR-11 (need to add type test)                 |
...
| 25 |                              | Shell orientation                | Outer shell outward, inner shells inward                    | ✅ TR-25 (need to consider inner shells as well) |
...
| 28 |                              | No overlapping solids            | Solids in same theme cannot overlap (by 3D AABB)            | ✅ TR-08 (need to add type test)                 |
